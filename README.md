...
This script takes two parameters: the input directory (required) containing the batch of files you want to process and the output directory (optional) if you want the new subdirectories and srt files saved somewhere else. 
